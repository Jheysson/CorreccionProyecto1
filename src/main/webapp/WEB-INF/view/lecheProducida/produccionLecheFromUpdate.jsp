			...
			<nav class="navbar top-navbar navbar-expand-md navbar-light">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="index.html"> <!-- Logo icon --> <b>
							...
							src="../../img/logo-light-text.png" class="light-logo"
							alt="homepage" /></span>
					</a>
				</div>
				<!-- ============================================================== -->
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						<li class="user-profile"><a
							...
							aria-expanded="false"><img src="../../img/kent.jpg"
								alt="user" /><span class="hide-menu">Kent Naiki </span></a>
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">Modificar Registro</h3>
					</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<spring:url value="/lecheProducida/update.lhs" var="updateURL" />
								<form:form modelAttribute="lecheProducida/produccionLecheFromUpdate"
									method="POST" action="${updateURL}" cssClass="form">

									<div class="form-row">
										<form:hidden path="idLechProd" />
										
										<div class="form-group col-md-6">
											<label for="cantLitrLechProd">Cantidad Lts.</label>
											<form:input  path="cantLitrLechProd"
												class="form-control" id="cantLitrLechProd" />
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="fechLechProd">Fecha Produccion</label>
											<form:input type="date" path="fechLechProd"
												class="form-control" id="fechLechProd" />
										</div>
										<div class="form-group col-md-6">
											<label for="vacaProducion">CUIA Producctora</label>
											<form:input type="number" path="vacaProducion"
												class="form-control" id="vacaProducion" />
										</div>
									</div>
