...
<body class="fix-header card-no-border fix-sidebar">
	...
	<div id="main-wrapper">
					...
					<ul id="sidebarnav">
						...
						<li><a class="has-arrow waves-effect waves-dark" href="#"
							...
							<ul aria-expanded="false" class="collapse">
								...
								<li><a href="index2.html">Natalidad</a></li>
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					...
					<div class="col-md-7 align-self-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">Ganado Vacuno</li>
							<li class="breadcrumb-item active">Registro Ganado Vacuno</li>
						</ol>
					</div>
					<div>
						<button
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<spring:url value="/ganadoVacuno/updateGV.lhs" var="updateURL" />
								<form:form modelAttribute="ganadoVacuno/ganadoVacunoUpdate"
									method="POST" action="${updateURL }" class="form">
									<form:hidden path="cuia" />
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="aliasGanadoVacuno">Alias</label>
											<form:input path="aliasGanadoVacuno" class="form-control"
												id="aliasGanadoVacuno" />
										</div>
										<div class="form-group col-md-6">
											<label for="fecha_nacimiento">Fecha Nacimiento</label>
											<form:input path="fecha_nacimiento" class="form-control"
												id="fecha_nacimiento" />
										</div>
									</div>
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<form:select class="form-control col-12" path="sexo" id="sexo" >
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<form:input path="peso" class="form-control" id="peso" />
										</div>
										<div class="form-group col-md-6">
											<label for="talla">Talla</label>
											<form:input path="talla" class="form-control" id="talla" />
										</div>
									</div>
									<div class="form-row">

										<div class="form-group col-md-6">
											<label for="estaActivo">Estado Activo</label>
										...
										<div class="form-group col-md-6">
											<label for="estaAnim">Estado Animal</label>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="tipoGana">Tipo Ganado</label>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="cuiaPadre">CUIA Padre</label>
											<form:input path="cuiaPadre" class="form-control"
												id="cuiaPadre" />
										</div>
										<div class="form-group col-md-6">
											<label for="cuiaMadre">CUIA Madre</label>
											<form:input path="cuiaMadre" class="form-control"
												id="cuiaMadre" />
										</div>
									</div>
			...
			<!-- footer -->
			<!-- ============================================================== -->
			<footer class="footer"> © 2020 Ganado Vacuno Grupo 2</footer>
			<!-- ============================================================== -->
			<!-- End footer -->
			<!-- ============================================================== -->
		</div>
