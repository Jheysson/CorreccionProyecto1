...
<link rel="stylesheet" type="text/css" href="css/styleGeneral/style.css" />
<!-- icons  fontawesome-->
...
<body class="fix-header card-no-border fix-sidebar">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="index.html"> <!-- Logo icon -->
						<b> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
							...
							src="img/logo-light-icon.png" alt="homepage" class="light-logo" />
					</b> <!--End Logo icon --> <!-- Logo text -->
						<span> <!-- dark Logo text --> <img src="img/logo-text.png"
							alt="homepage" class="dark-logo" /> <!-- Light Logo text --> <img
							src="img/logo-light-text.png" class="light-logo" alt="homepage" /></span>
					</a>
				</div>
				<!-- ============================================================== -->
				<!-- End Logo -->
	...
	<script src="js/plugins/slimscrollbar/perfect-scrollbar.jquery.min.js"></script>
	<!--Wave Effects -->
