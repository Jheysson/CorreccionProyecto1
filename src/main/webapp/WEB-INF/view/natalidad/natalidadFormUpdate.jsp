			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<spring:url value="/natalidad/update.lhs" var="updateURL" />
								<form:form modelAttribute="natalidad/natalidadFormUpdate" method="POST"
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<form:input path="fechNacimiento" class="form-control"
												id="fechNacimiento" />
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<form:input path="genotipo" class="form-control"
												id="genotipo" />
										</div>
										<div class="form-group col-md-6">
											<label for="sexo">Sexo</label>
											<form:input path="sexo" class="form-control" id="sexo" />
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
