					...
					<ul id="sidebarnav">
						...
						<li><a class="has-arrow waves-effect waves-dark" href="#"
							...
							<ul aria-expanded="false" class="collapse">
								...
								<li><a href="../ganadoVacuno/ListadoGanadoVacuno.lhs">Ganado
										Vacuno</a></li>
								<li><a href="../ganadoEnfermo/ListadoGanadoEnfermo.lhs">Ganado
										Enfermo</a></li>
								<li><a href="../inseminacion/ListadoInseminacion.lhs">Inseminacion</a></li>
								<li><a href="../lecheProducida/jspProducionLeche.lhs">Producción
										de leche</a></li>
							</ul></li>
					</ul>
				</nav>
				...
				<div class="row page-titles">
					...
					<div class="col-md-7 align-self-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Listado de Natalidad</li>
						</ol>
					</div>
					<div>
						<button
							...
							<div class="card-body">
								<div style="margin-top: 20px; margin-left: 20px">
									<div class="d-flex">
										<div class="mr-auto">
											<div class="form-group">
												<co:url value="/natalidad/agregarNatalidad.lhs"
													var="mensaje"></co:url>
												<a class="btn btn-primary" href="${mensaje}">agregar
													Registro de Natalidad</a>
											</div>
										</div>
									</div>
									<table id="myTable"
										...
										<tbody>
											<co:forEach items="${model.listNatalidad}" var="itemcic">
												<tr>
													...
													<td><spring:url
															value="/natalidad/updateNatalidad.lhs/${itemcic.CUIA}.lhs"
															var="updateURL" /> <a class="btn btn-primary"
														href="${updateURL}" role="button">Update</a></td>
													<td><spring:url
															value="/natalidad/eliminarNatalidad.lhs/${itemcic.CUIA}.lhs"
