			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">Registro Inseminacion</h3>
					</div>
					<div class="col-md-7 align-self-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Registro Inseminacion</li>
						</ol>
					</div>
					<div>
						<button
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<spring:url value="/inseminacion/saveI.lhs" var="saveURL" />
								<form:form modelAttribute="inseminacion/inseminacionForm"
									method="post" action="${saveURL }" cssClass="form">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="codigo">codigo</label>
											<form:input path="codigo" class="form-control" id="codigo" />
										</div>
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<form:input path="fechcompra"  type="date" class="form-control"
												id="fechcompra" />
										</div>
										</div>
										<div class="form-row">
