			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">Registro Natalidad</h3>
					</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<spring:url value="/natalidad/save.lhs" var="saveURL" />
								<form:form modelAttribute="natalidad/natalidadForm"
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<form:input class="form-control" type="date" path="fechNacimiento"
												id="fechNacimiento" />
										</div>
									</div>
									<div class="form-row">
