							...
							<div class="card-body">
								<div style="margin-top: 20px; margin-left: 20px">
									...
									<div class="d-flex">
										<div class="mr-auto">
											<div class="form-group">
												<co:url value="/inseminacion/agregarPropInse.lhs"
													var="mensaje"></co:url>
												<a class="btn btn-primary" href="${mensaje}">agregar
													Registro de Inseminacion</a>
											</div>
										</div>
									</div>
									<table id="myTable"
