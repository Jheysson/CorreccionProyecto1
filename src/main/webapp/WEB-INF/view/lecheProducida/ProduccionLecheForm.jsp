				...
				<div class="row page-titles">
					...
					<div class="col-md-7 align-self-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Registro Natalidad</li>
						</ol>
					</div>
					<div>
						<button
								...
								<form:form modelAttribute="lecheProducida/ProduccionLecheForm"
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="idLechProd" >ID Produccion (se anula al usar BD)</label>
											<form:input type="number"  path="idLechProd" class="form-control" id="CUIA" />
										</div>
										<div class="form-group col-md-6">
											<label for="cantLitrLechProd">Cantidad Lts.</label>
											<form:input path="cantLitrLechProd" class="form-control"
												id="cantLitrLechProd" />
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<form:input type="date" path="fechLechProd" class="form-control" id="fechLechProd" />
										</div>
										<div class="form-group col-md-6">
											<label for="vacaProducion">CUIA Producctora</label>
											<form:input type="number" path="vacaProducion" class="form-control"
												id="vacaProducion" />
										</div>
									</div>
