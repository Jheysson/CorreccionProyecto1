			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="nav-small-cap">PRODUCCION DE LECHE</li>
						...
						<li><a class="has-arrow waves-effect waves-dark" href="#"
							aria-expanded="falc"><i class="mdi mdi-bullseye"></i><span
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">Produccion de Leche</h3>
					</div>
					<div class="col-md-7 align-self-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">Produccion</li>
							<li class="breadcrumb-item ">Listado de Produccion de Leche</li>
						</ol>
					</div>
					<div>
						<button
								...
								<div style="margin-top: 20px; margin-left: 20px">
									<div class="d-flex">
										<div class="mr-auto">
											<div class="form-group">
												<co:url
													value="/lecheProducida/agregarProduccionLecheForm.lhs"
													var="mensaje"></co:url>
									...
									<div class="container">
										<div class="container tab-pane active">
											<table id="myTable"
												...
												<tbody>
													<co:forEach items="${model.listLecheProducida}"
														var="itemcic">
														<tr>
															<td><co:out value="${itemcic.idLechProd}"></co:out></td>
															<td><co:out value="${itemcic.cantLitrLechProd}"></co:out></td>
															<td><co:out value="${itemcic.fechLechProd}"></co:out></td>
															<td><co:out value="${itemcic.vacaProducion}"></co:out></td>

															<td><spring:url
																	value="/lecheProducida/updateProduccionLeche.lhs/${itemcic.idLechProd}.lhs"
																	var="updateURL" /> <a class="btn btn-primary"
																href="${updateURL}" role="button">Update</a></td>
															<td><spring:url
																	value="/lecheProducida/eliminarProduccionLeche.lhs/${itemcic.idLechProd}.lhs"
